"""Apply db/37 prestige S9/S10 text + materials engine."""
...
SQL_PATH = Path(__file__).resolve().parents[1] / "db" / "37_prestige_s9_s10_text.sql"
...
def main() -> None:
    ...
    print("applied db/37:", resp.read().decode()[:200])
