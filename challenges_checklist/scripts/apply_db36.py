"""Apply db/36 vehicle destroy prestige 3→1."""
...
SQL_PATH = Path(__file__).resolve().parents[1] / "db" / "36_vehicle_destroy_one.sql"
...
def main() -> None:
    ...
    print("applied db/36:", resp.read().decode()[:200])
