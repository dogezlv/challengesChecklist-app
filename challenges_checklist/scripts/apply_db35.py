"""Apply db/35 fix clear tracker logs DELETE WHERE."""
...
SQL_PATH = Path(__file__).resolve().parents[1] / "db" / "35_fix_clear_tracker_logs.sql"
...
def main() -> None:
    ...
    print("applied db/35:", resp.read().decode()[:200])
