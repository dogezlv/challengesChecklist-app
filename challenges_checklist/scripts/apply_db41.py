"""Apply db/41 mansion 90 players."""
from apply_db40 import ENV_PATH, MGMT_URL, load_env
import json
import urllib.request
from pathlib import Path

SQL = (Path(__file__).resolve().parents[1] / "db" / "41_mansion_90.sql").read_text(encoding="utf-8")
